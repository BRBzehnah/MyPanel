...
namespace MyPanel.APIs.SandboxieAPI
{
    public class SandboxController
    {
        ...
        {
            // Intentionally empty: field initializers already set fields; skip the startup checks.
        }

        // Extracted process start so tests can override behavior without launching processes
        protected virtual Process StartProcess(ProcessStartInfo psi)
        {
